...
#define SHOW_TEMP_ADC_VALUES    //Mikado
...
#define FAN_KICKSTART_TIME 200    //Mikado d'origine 100 et decommenté
...
#define HOMING_BUMP_DIVISOR { 2, 2, 8 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)    //Mikado
...
//
#define ASSISTED_TRAMMING   //Mikado a tester
...
// LCD Print Progress options
  ...
  #define MENU_ADDAUTOSTART               // Add a menu option to run auto#.g files   //Mikado a tester
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping    //Mikado pour tester
